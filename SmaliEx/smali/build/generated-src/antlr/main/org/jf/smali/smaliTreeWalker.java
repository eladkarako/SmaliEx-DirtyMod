// $ANTLR 3.5.2 smaliTreeWalker.g 2020-09-12 15:08:29
...
public class smaliTreeWalker extends TreeParser {
	...
	// smaliTreeWalker.g:524:1: method_handle_type returns [int methodHandleType] : ( METHOD_HANDLE_TYPE_FIELD | METHOD_HANDLE_TYPE_METHOD );
	public final smaliTreeWalker.method_handle_type_return method_handle_type() throws RecognitionException {
		...
		try {
			// smaliTreeWalker.g:525:3: ( METHOD_HANDLE_TYPE_FIELD | METHOD_HANDLE_TYPE_METHOD )
			int alt18=2;
			int LA18_0 = input.LA(1);
			if ( (LA18_0==METHOD_HANDLE_TYPE_FIELD) ) {
				alt18=1;
			}
			else if ( (LA18_0==METHOD_HANDLE_TYPE_METHOD) ) {
				alt18=2;
			}
			...
			switch (alt18) {
				case 1 :
					// smaliTreeWalker.g:525:5: METHOD_HANDLE_TYPE_FIELD
					{
					match(input,METHOD_HANDLE_TYPE_FIELD,FOLLOW_METHOD_HANDLE_TYPE_FIELD_in_method_handle_type1245); 
					}
					break;
				case 2 :
					// smaliTreeWalker.g:525:32: METHOD_HANDLE_TYPE_METHOD
					{
					match(input,METHOD_HANDLE_TYPE_METHOD,FOLLOW_METHOD_HANDLE_TYPE_METHOD_in_method_handle_type1249); 
	...
	public final ImmutableMethodHandleReference method_handle_reference() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_method_handle_type_in_method_handle_reference1264);
			...
			switch (alt19) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_field_reference_in_method_handle_reference1267);
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_method_reference_in_method_handle_reference1271);
	...
	public final ImmutableMethodHandleReference method_handle_literal() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ENCODED_METHOD_HANDLE,FOLLOW_I_ENCODED_METHOD_HANDLE_in_method_handle_literal1288); 
			pushFollow(FOLLOW_method_handle_reference_in_method_handle_literal1290);
		...
		try {
			...
			switch (alt20) {
				case 1 :
					// smaliTreeWalker.g:546:5: reference_type_descriptor
					{
					pushFollow(FOLLOW_reference_type_descriptor_in_method_reference1306);
			...
			SIMPLE_NAME87=(CommonTree)match(input,SIMPLE_NAME,FOLLOW_SIMPLE_NAME_in_method_reference1309); 
			pushFollow(FOLLOW_method_prototype_in_method_reference1311);
		...
		try {
			...
			switch (alt21) {
				case 1 :
					// smaliTreeWalker.g:559:5: reference_type_descriptor
					{
					pushFollow(FOLLOW_reference_type_descriptor_in_field_reference1328);
			...
			SIMPLE_NAME90=(CommonTree)match(input,SIMPLE_NAME,FOLLOW_SIMPLE_NAME_in_field_reference1331); 
			pushFollow(FOLLOW_nonvoid_type_descriptor_in_field_reference1333);
		...
		try {
			...
			switch (alt22) {
				case 1 :
					...
					{
					match(input,I_REGISTERS,FOLLOW_I_REGISTERS_in_registers_directive1359); 
				...
				case 2 :
					...
					{
					match(input,I_LOCALS,FOLLOW_I_LOCALS_in_registers_directive1371); 
			...
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_short_integral_literal_in_registers_directive1389);
	...
	public final void label_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_LABEL,FOLLOW_I_LABEL_in_label_def1409); 
			match(input, Token.DOWN, null); 
			SIMPLE_NAME93=(CommonTree)match(input,SIMPLE_NAME,FOLLOW_SIMPLE_NAME_in_label_def1411); 
			match(input, Token.UP, null); 
	...
	public final List<BuilderTryBlock> catches() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_CATCHES,FOLLOW_I_CATCHES_in_catches1437); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						// smaliTreeWalker.g:587:17: catch_directive
						{
						pushFollow(FOLLOW_catch_directive_in_catches1439);
						catch_directive();
						state._fsp--;
				...
				while (true) {
					...
					case 1 :
						// smaliTreeWalker.g:587:34: catchall_directive
						{
						pushFollow(FOLLOW_catchall_directive_in_catches1442);
						catchall_directive();
						state._fsp--;
	...
	public final void catch_directive() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_CATCH,FOLLOW_I_CATCH_in_catch_directive1455); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_nonvoid_type_descriptor_in_catch_directive1457);
			nonvoid_type_descriptor94=nonvoid_type_descriptor();
			state._fsp--;

			pushFollow(FOLLOW_label_ref_in_catch_directive1461);
			from=label_ref();
			state._fsp--;

			pushFollow(FOLLOW_label_ref_in_catch_directive1465);
			to=label_ref();
			state._fsp--;

			pushFollow(FOLLOW_label_ref_in_catch_directive1469);
			using=label_ref();
			state._fsp--;
	...
	public final void catchall_directive() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_CATCHALL,FOLLOW_I_CATCHALL_in_catchall_directive1485); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_label_ref_in_catchall_directive1489);
			from=label_ref();
			state._fsp--;

			pushFollow(FOLLOW_label_ref_in_catchall_directive1493);
			to=label_ref();
			state._fsp--;

			pushFollow(FOLLOW_label_ref_in_catchall_directive1497);
			using=label_ref();
			state._fsp--;
	...
	public final void parameters(List<SmaliMethodParameter> parameters) throws RecognitionException {
		try {
			...
			{
			match(input,I_PARAMETERS,FOLLOW_I_PARAMETERS_in_parameters1514); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_parameter_in_parameters1517);
	...
	public final void parameter(List<SmaliMethodParameter> parameters) throws RecognitionException {
		...
		try {
			...
			{
			I_PARAMETER96=(CommonTree)match(input,I_PARAMETER,FOLLOW_I_PARAMETER_in_parameter1533); 
			match(input, Token.DOWN, null); 
			REGISTER95=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_parameter1535); 
			...
			switch (alt26) {
				case 1 :
					// smaliTreeWalker.g:606:28: string_literal
					{
					pushFollow(FOLLOW_string_literal_in_parameter1537);
			...
			pushFollow(FOLLOW_annotations_in_parameter1540);
		...
		try {
			...
			switch (alt27) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_line_in_debug_directive1557);
					line();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_local_in_debug_directive1563);
					local();
					state._fsp--;
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_end_local_in_debug_directive1569);
					end_local();
					state._fsp--;
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_restart_local_in_debug_directive1575);
					restart_local();
					state._fsp--;
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_prologue_in_debug_directive1581);
					prologue();
					state._fsp--;
				...
				case 6 :
					...
					{
					pushFollow(FOLLOW_epilogue_in_debug_directive1587);
					epilogue();
					state._fsp--;
				...
				case 7 :
					...
					{
					pushFollow(FOLLOW_source_in_debug_directive1593);
					source();
					state._fsp--;
	...
	public final void line() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_LINE,FOLLOW_I_LINE_in_line1604); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_integral_literal_in_line1606);
	...
	public final void local() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_LOCAL,FOLLOW_I_LOCAL_in_local1624); 
			match(input, Token.DOWN, null); 
			REGISTER100=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_local1626); 
				...
				case 1 :
					...
					switch (alt28) {
						case 1 :
							...
							{
							match(input,NULL_LITERAL,FOLLOW_NULL_LITERAL_in_local1630); 
							}
							break;
						case 2 :
							// smaliTreeWalker.g:655:41: name= string_literal
							{
							pushFollow(FOLLOW_string_literal_in_local1636);
							name=string_literal();
							state._fsp--;
					...
					switch (alt29) {
						case 1 :
							// smaliTreeWalker.g:655:62: nonvoid_type_descriptor
							{
							pushFollow(FOLLOW_nonvoid_type_descriptor_in_local1639);
					...
					switch (alt30) {
						case 1 :
							// smaliTreeWalker.g:655:96: signature= string_literal
							{
							pushFollow(FOLLOW_string_literal_in_local1644);
	...
	public final void end_local() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_END_LOCAL,FOLLOW_I_END_LOCAL_in_end_local1665); 
			match(input, Token.DOWN, null); 
			REGISTER102=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_end_local1667); 
			match(input, Token.UP, null); 
	...
	public final void restart_local() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_RESTART_LOCAL,FOLLOW_I_RESTART_LOCAL_in_restart_local1685); 
			match(input, Token.DOWN, null); 
			REGISTER103=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_restart_local1687); 
			match(input, Token.UP, null); 
	...
	public final void prologue() throws RecognitionException {
		try {
			...
			{
			match(input,I_PROLOGUE,FOLLOW_I_PROLOGUE_in_prologue1704); 
	...
	public final void epilogue() throws RecognitionException {
		try {
			...
			{
			match(input,I_EPILOGUE,FOLLOW_I_EPILOGUE_in_epilogue1720); 
	...
	public final void source() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_SOURCE,FOLLOW_I_SOURCE_in_source1737); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				switch (alt32) {
					case 1 :
						// smaliTreeWalker.g:691:16: string_literal
						{
						pushFollow(FOLLOW_string_literal_in_source1739);
	...
	public final List<ImmutableEncodedValue> call_site_extra_arguments() throws RecognitionException {
		...
		try {
			...
			match(input,I_CALL_SITE_EXTRA_ARGUMENTS,FOLLOW_I_CALL_SITE_EXTRA_ARGUMENTS_in_call_site_extra_arguments1765); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_literal_in_call_site_extra_arguments1768);
						literal105=literal();
						state._fsp--;
	...
	public final void ordered_method_items() throws RecognitionException {
		try {
			...
			{
			match(input,I_ORDERED_METHOD_ITEMS,FOLLOW_I_ORDERED_METHOD_ITEMS_in_ordered_method_items1784); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_label_def_in_ordered_method_items1787);
						label_def();
						state._fsp--;
					...
					case 2 :
						...
						{
						pushFollow(FOLLOW_instruction_in_ordered_method_items1791);
						instruction();
						state._fsp--;
					...
					case 3 :
						...
						{
						pushFollow(FOLLOW_debug_directive_in_ordered_method_items1795);
						debug_directive();
						state._fsp--;
	...
	public final Label label_ref() throws RecognitionException {
		...
		try {
			...
			{
			SIMPLE_NAME106=(CommonTree)match(input,SIMPLE_NAME,FOLLOW_SIMPLE_NAME_in_label_ref1811); 
	...
	public final smaliTreeWalker.register_list_return register_list() throws RecognitionException {
		...
		try {
			...
			{
			I_REGISTER_LIST107=(CommonTree)match(input,I_REGISTER_LIST,FOLLOW_I_REGISTER_LIST_in_register_list1836); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						REGISTER108=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_register_list1845); 
	...
	public final smaliTreeWalker.register_range_return register_range() throws RecognitionException {
		...
		try {
			...
			{
			I_REGISTER_RANGE109=(CommonTree)match(input,I_REGISTER_RANGE,FOLLOW_I_REGISTER_RANGE_in_register_range1870); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				switch (alt37) {
					case 1 :
						...
						{
						startReg=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_register_range1875); 
						...
						switch (alt36) {
							case 1 :
								// smaliTreeWalker.g:723:49: endReg= REGISTER
								{
								endReg=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_register_range1879); 
								}
								break;
		...
		try {
			...
			switch (alt38) {
				case 1 :
					...
					{
					CLASS_DESCRIPTOR110=(CommonTree)match(input,CLASS_DESCRIPTOR,FOLLOW_CLASS_DESCRIPTOR_in_verification_error_reference1902); 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_field_reference_in_verification_error_reference1912);
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_method_reference_in_verification_error_reference1922);
	...
	public final int verification_error_type() throws RecognitionException {
		...
		try {
			...
			{
			VERIFICATION_ERROR_TYPE113=(CommonTree)match(input,VERIFICATION_ERROR_TYPE,FOLLOW_VERIFICATION_ERROR_TYPE_in_verification_error_type1939); 
		...
		try {
			...
			switch (alt39) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_insn_format10t_in_instruction1953);
					insn_format10t();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_insn_format10x_in_instruction1959);
					insn_format10x();
					state._fsp--;
				...
				case 9 :
					...
					{
					pushFollow(FOLLOW_insn_format21c_method_handle_in_instruction2001);
				...
				case 10 :
					...
					{
					pushFollow(FOLLOW_insn_format21c_method_type_in_instruction2007);
				...
				case 11 :
					...
					{
					pushFollow(FOLLOW_insn_format21c_string_in_instruction2013);
				...
				case 12 :
					...
					{
					pushFollow(FOLLOW_insn_format21c_type_in_instruction2019);
					insn_format21c_type();
					state._fsp--;
				...
				case 13 :
					...
					{
					pushFollow(FOLLOW_insn_format21ih_in_instruction2025);
					insn_format21ih();
					state._fsp--;
				...
				case 14 :
					...
					{
					pushFollow(FOLLOW_insn_format21lh_in_instruction2031);
					insn_format21lh();
					state._fsp--;
				...
				case 15 :
					...
					{
					pushFollow(FOLLOW_insn_format21s_in_instruction2037);
					insn_format21s();
					state._fsp--;
				...
				case 16 :
					...
					{
					pushFollow(FOLLOW_insn_format21t_in_instruction2043);
					insn_format21t();
					state._fsp--;
				...
				case 17 :
					...
					{
					pushFollow(FOLLOW_insn_format22b_in_instruction2049);
					insn_format22b();
					state._fsp--;
				...
				case 18 :
					...
					{
					pushFollow(FOLLOW_insn_format22c_field_in_instruction2055);
				...
				case 19 :
					...
					{
					pushFollow(FOLLOW_insn_format22c_type_in_instruction2061);
					insn_format22c_type();
					state._fsp--;
				...
				case 29 :
					...
					{
					pushFollow(FOLLOW_insn_format35c_call_site_in_instruction2121);
				...
				case 30 :
					...
					{
					pushFollow(FOLLOW_insn_format35c_method_in_instruction2127);
				...
				case 31 :
					...
					{
					pushFollow(FOLLOW_insn_format35c_type_in_instruction2133);
					insn_format35c_type();
					state._fsp--;
				...
				case 32 :
					...
					{
					pushFollow(FOLLOW_insn_format3rc_call_site_in_instruction2139);
				...
				case 33 :
					...
					{
					pushFollow(FOLLOW_insn_format3rc_method_in_instruction2145);
				...
				case 34 :
					...
					{
					pushFollow(FOLLOW_insn_format3rc_type_in_instruction2151);
					insn_format3rc_type();
					state._fsp--;
				...
				case 35 :
					...
					{
					pushFollow(FOLLOW_insn_format45cc_method_in_instruction2157);
					insn_format45cc_method();
					state._fsp--;
				...
				case 36 :
					...
					{
					pushFollow(FOLLOW_insn_format4rcc_method_in_instruction2163);
					insn_format4rcc_method();
					state._fsp--;
				...
				case 37 :
					...
					{
					pushFollow(FOLLOW_insn_format51l_type_in_instruction2169);
					insn_format51l_type();
					state._fsp--;
				...
				case 38 :
					...
					{
					pushFollow(FOLLOW_insn_array_data_directive_in_instruction2175);
				...
				case 39 :
					...
					{
					pushFollow(FOLLOW_insn_packed_switch_directive_in_instruction2181);
				...
				case 40 :
					...
					{
					pushFollow(FOLLOW_insn_sparse_switch_directive_in_instruction2187);
					insn_sparse_switch_directive();
					state._fsp--;
	...
	public final void insn_format10t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT10t,FOLLOW_I_STATEMENT_FORMAT10t_in_insn_format10t2211); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT10t114=(CommonTree)match(input,INSTRUCTION_FORMAT10t,FOLLOW_INSTRUCTION_FORMAT10t_in_insn_format10t2213); 
			pushFollow(FOLLOW_label_ref_in_insn_format10t2215);
	...
	public final void insn_format10x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT10x,FOLLOW_I_STATEMENT_FORMAT10x_in_insn_format10x2238); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT10x116=(CommonTree)match(input,INSTRUCTION_FORMAT10x,FOLLOW_INSTRUCTION_FORMAT10x_in_insn_format10x2240); 
			match(input, Token.UP, null); 
	...
	public final void insn_format11n() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT11n,FOLLOW_I_STATEMENT_FORMAT11n_in_insn_format11n2263); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT11n117=(CommonTree)match(input,INSTRUCTION_FORMAT11n,FOLLOW_INSTRUCTION_FORMAT11n_in_insn_format11n2265); 
			REGISTER118=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format11n2267); 
			pushFollow(FOLLOW_short_integral_literal_in_insn_format11n2269);
	...
	public final void insn_format11x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT11x,FOLLOW_I_STATEMENT_FORMAT11x_in_insn_format11x2292); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT11x120=(CommonTree)match(input,INSTRUCTION_FORMAT11x,FOLLOW_INSTRUCTION_FORMAT11x_in_insn_format11x2294); 
			REGISTER121=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format11x2296); 
			match(input, Token.UP, null); 
	...
	public final void insn_format12x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT12x,FOLLOW_I_STATEMENT_FORMAT12x_in_insn_format12x2319); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT12x122=(CommonTree)match(input,INSTRUCTION_FORMAT12x,FOLLOW_INSTRUCTION_FORMAT12x_in_insn_format12x2321); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format12x2325); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format12x2329); 
			match(input, Token.UP, null); 
	...
	public final void insn_format20bc() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT20bc,FOLLOW_I_STATEMENT_FORMAT20bc_in_insn_format20bc2352); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT20bc123=(CommonTree)match(input,INSTRUCTION_FORMAT20bc,FOLLOW_INSTRUCTION_FORMAT20bc_in_insn_format20bc2354); 
			pushFollow(FOLLOW_verification_error_type_in_insn_format20bc2356);
			verification_error_type124=verification_error_type();
			state._fsp--;

			pushFollow(FOLLOW_verification_error_reference_in_insn_format20bc2358);
	...
	public final void insn_format20t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT20t,FOLLOW_I_STATEMENT_FORMAT20t_in_insn_format20t2381); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT20t126=(CommonTree)match(input,INSTRUCTION_FORMAT20t,FOLLOW_INSTRUCTION_FORMAT20t_in_insn_format20t2383); 
			pushFollow(FOLLOW_label_ref_in_insn_format20t2385);
	...
	public final void insn_format21c_field() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21c_FIELD,FOLLOW_I_STATEMENT_FORMAT21c_FIELD_in_insn_format21c_field2408); 
			match(input, Token.DOWN, null); 
			...
			REGISTER128=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21c_field2420); 
			pushFollow(FOLLOW_field_reference_in_insn_format21c_field2422);
	...
	public final void insn_format21c_method_handle() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21c_METHOD_HANDLE,FOLLOW_I_STATEMENT_FORMAT21c_METHOD_HANDLE_in_insn_format21c_method_handle2445); 
			match(input, Token.DOWN, null); 
			// smaliTreeWalker.g:895:48: ( INSTRUCTION_FORMAT21c_METHOD_HANDLE )
			// smaliTreeWalker.g:895:49: INSTRUCTION_FORMAT21c_METHOD_HANDLE
			{
			inst=(CommonTree)match(input,INSTRUCTION_FORMAT21c_METHOD_HANDLE,FOLLOW_INSTRUCTION_FORMAT21c_METHOD_HANDLE_in_insn_format21c_method_handle2450); 
			}

			REGISTER130=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21c_method_handle2453); 
			pushFollow(FOLLOW_method_handle_reference_in_insn_format21c_method_handle2455);
	...
	public final void insn_format21c_method_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21c_METHOD_TYPE,FOLLOW_I_STATEMENT_FORMAT21c_METHOD_TYPE_in_insn_format21c_method_type2478); 
			match(input, Token.DOWN, null); 
			// smaliTreeWalker.g:908:46: ( INSTRUCTION_FORMAT21c_METHOD_TYPE )
			// smaliTreeWalker.g:908:47: INSTRUCTION_FORMAT21c_METHOD_TYPE
			{
			inst=(CommonTree)match(input,INSTRUCTION_FORMAT21c_METHOD_TYPE,FOLLOW_INSTRUCTION_FORMAT21c_METHOD_TYPE_in_insn_format21c_method_type2483); 
			}

			REGISTER132=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21c_method_type2486); 
			pushFollow(FOLLOW_method_prototype_in_insn_format21c_method_type2488);
	...
	public final void insn_format21c_string() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21c_STRING,FOLLOW_I_STATEMENT_FORMAT21c_STRING_in_insn_format21c_string2511); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21c_STRING134=(CommonTree)match(input,INSTRUCTION_FORMAT21c_STRING,FOLLOW_INSTRUCTION_FORMAT21c_STRING_in_insn_format21c_string2513); 
			REGISTER135=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21c_string2515); 
			pushFollow(FOLLOW_string_literal_in_insn_format21c_string2517);
	...
	public final void insn_format21c_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21c_TYPE,FOLLOW_I_STATEMENT_FORMAT21c_TYPE_in_insn_format21c_type2540); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21c_TYPE137=(CommonTree)match(input,INSTRUCTION_FORMAT21c_TYPE,FOLLOW_INSTRUCTION_FORMAT21c_TYPE_in_insn_format21c_type2542); 
			REGISTER138=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21c_type2544); 
			pushFollow(FOLLOW_nonvoid_type_descriptor_in_insn_format21c_type2546);
	...
	public final void insn_format21ih() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21ih,FOLLOW_I_STATEMENT_FORMAT21ih_in_insn_format21ih2569); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21ih140=(CommonTree)match(input,INSTRUCTION_FORMAT21ih,FOLLOW_INSTRUCTION_FORMAT21ih_in_insn_format21ih2571); 
			REGISTER141=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21ih2573); 
			pushFollow(FOLLOW_fixed_32bit_literal_in_insn_format21ih2575);
	...
	public final void insn_format21lh() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21lh,FOLLOW_I_STATEMENT_FORMAT21lh_in_insn_format21lh2598); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21lh143=(CommonTree)match(input,INSTRUCTION_FORMAT21lh,FOLLOW_INSTRUCTION_FORMAT21lh_in_insn_format21lh2600); 
			REGISTER144=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21lh2602); 
			pushFollow(FOLLOW_fixed_64bit_literal_in_insn_format21lh2604);
	...
	public final void insn_format21s() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21s,FOLLOW_I_STATEMENT_FORMAT21s_in_insn_format21s2627); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21s146=(CommonTree)match(input,INSTRUCTION_FORMAT21s,FOLLOW_INSTRUCTION_FORMAT21s_in_insn_format21s2629); 
			REGISTER147=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21s2631); 
			pushFollow(FOLLOW_short_integral_literal_in_insn_format21s2633);
	...
	public final void insn_format21t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT21t,FOLLOW_I_STATEMENT_FORMAT21t_in_insn_format21t2656); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT21t149=(CommonTree)match(input,INSTRUCTION_FORMAT21t,FOLLOW_INSTRUCTION_FORMAT21t_in_insn_format21t2658); 
			REGISTER150=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format21t2660); 
			pushFollow(FOLLOW_label_ref_in_insn_format21t2662);
	...
	public final void insn_format22b() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22b,FOLLOW_I_STATEMENT_FORMAT22b_in_insn_format22b2685); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT22b152=(CommonTree)match(input,INSTRUCTION_FORMAT22b,FOLLOW_INSTRUCTION_FORMAT22b_in_insn_format22b2687); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22b2691); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22b2695); 
			pushFollow(FOLLOW_short_integral_literal_in_insn_format22b2697);
	...
	public final void insn_format22c_field() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22c_FIELD,FOLLOW_I_STATEMENT_FORMAT22c_FIELD_in_insn_format22c_field2720); 
			match(input, Token.DOWN, null); 
			inst=(CommonTree)input.LT(1);
			...
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22c_field2734); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22c_field2738); 
			pushFollow(FOLLOW_field_reference_in_insn_format22c_field2740);
	...
	public final void insn_format22c_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22c_TYPE,FOLLOW_I_STATEMENT_FORMAT22c_TYPE_in_insn_format22c_type2763); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT22c_TYPE155=(CommonTree)match(input,INSTRUCTION_FORMAT22c_TYPE,FOLLOW_INSTRUCTION_FORMAT22c_TYPE_in_insn_format22c_type2765); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22c_type2769); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22c_type2773); 
			pushFollow(FOLLOW_nonvoid_type_descriptor_in_insn_format22c_type2775);
	...
	public final void insn_format22s() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22s,FOLLOW_I_STATEMENT_FORMAT22s_in_insn_format22s2798); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT22s157=(CommonTree)match(input,INSTRUCTION_FORMAT22s,FOLLOW_INSTRUCTION_FORMAT22s_in_insn_format22s2800); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22s2804); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22s2808); 
			pushFollow(FOLLOW_short_integral_literal_in_insn_format22s2810);
	...
	public final void insn_format22t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22t,FOLLOW_I_STATEMENT_FORMAT22t_in_insn_format22t2833); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT22t159=(CommonTree)match(input,INSTRUCTION_FORMAT22t,FOLLOW_INSTRUCTION_FORMAT22t_in_insn_format22t2835); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22t2839); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22t2843); 
			pushFollow(FOLLOW_label_ref_in_insn_format22t2845);
	...
	public final void insn_format22x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT22x,FOLLOW_I_STATEMENT_FORMAT22x_in_insn_format22x2868); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT22x161=(CommonTree)match(input,INSTRUCTION_FORMAT22x,FOLLOW_INSTRUCTION_FORMAT22x_in_insn_format22x2870); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22x2874); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format22x2878); 
			match(input, Token.UP, null); 
	...
	public final void insn_format23x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT23x,FOLLOW_I_STATEMENT_FORMAT23x_in_insn_format23x2901); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT23x162=(CommonTree)match(input,INSTRUCTION_FORMAT23x,FOLLOW_INSTRUCTION_FORMAT23x_in_insn_format23x2903); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format23x2907); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format23x2911); 
			registerC=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format23x2915); 
			match(input, Token.UP, null); 
	...
	public final void insn_format30t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT30t,FOLLOW_I_STATEMENT_FORMAT30t_in_insn_format30t2938); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT30t163=(CommonTree)match(input,INSTRUCTION_FORMAT30t,FOLLOW_INSTRUCTION_FORMAT30t_in_insn_format30t2940); 
			pushFollow(FOLLOW_label_ref_in_insn_format30t2942);
	...
	public final void insn_format31c() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT31c,FOLLOW_I_STATEMENT_FORMAT31c_in_insn_format31c2965); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT31c165=(CommonTree)match(input,INSTRUCTION_FORMAT31c,FOLLOW_INSTRUCTION_FORMAT31c_in_insn_format31c2967); 
			REGISTER166=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format31c2969); 
			pushFollow(FOLLOW_string_literal_in_insn_format31c2971);
	...
	public final void insn_format31i() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT31i,FOLLOW_I_STATEMENT_FORMAT31i_in_insn_format31i2994); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT31i168=(CommonTree)match(input,INSTRUCTION_FORMAT31i,FOLLOW_INSTRUCTION_FORMAT31i_in_insn_format31i2996); 
			REGISTER169=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format31i2998); 
			pushFollow(FOLLOW_fixed_32bit_literal_in_insn_format31i3000);
	...
	public final void insn_format31t() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT31t,FOLLOW_I_STATEMENT_FORMAT31t_in_insn_format31t3023); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT31t171=(CommonTree)match(input,INSTRUCTION_FORMAT31t,FOLLOW_INSTRUCTION_FORMAT31t_in_insn_format31t3025); 
			REGISTER172=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format31t3027); 
			pushFollow(FOLLOW_label_ref_in_insn_format31t3029);
	...
	public final void insn_format32x() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT32x,FOLLOW_I_STATEMENT_FORMAT32x_in_insn_format32x3052); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT32x174=(CommonTree)match(input,INSTRUCTION_FORMAT32x,FOLLOW_INSTRUCTION_FORMAT32x_in_insn_format32x3054); 
			registerA=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format32x3058); 
			registerB=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format32x3062); 
			match(input, Token.UP, null); 
	...
	public final void insn_format35c_call_site() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT35c_CALL_SITE,FOLLOW_I_STATEMENT_FORMAT35c_CALL_SITE_in_insn_format35c_call_site3090); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT35c_CALL_SITE175=(CommonTree)match(input,INSTRUCTION_FORMAT35c_CALL_SITE,FOLLOW_INSTRUCTION_FORMAT35c_CALL_SITE_in_insn_format35c_call_site3092); 
			pushFollow(FOLLOW_register_list_in_insn_format35c_call_site3094);
			register_list176=register_list();
			state._fsp--;

			pushFollow(FOLLOW_call_site_reference_in_insn_format35c_call_site3096);
	...
	public final void insn_format35c_method() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT35c_METHOD,FOLLOW_I_STATEMENT_FORMAT35c_METHOD_in_insn_format35c_method3119); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT35c_METHOD178=(CommonTree)match(input,INSTRUCTION_FORMAT35c_METHOD,FOLLOW_INSTRUCTION_FORMAT35c_METHOD_in_insn_format35c_method3121); 
			pushFollow(FOLLOW_register_list_in_insn_format35c_method3123);
			register_list179=register_list();
			state._fsp--;

			pushFollow(FOLLOW_method_reference_in_insn_format35c_method3125);
	...
	public final void insn_format35c_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT35c_TYPE,FOLLOW_I_STATEMENT_FORMAT35c_TYPE_in_insn_format35c_type3148); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT35c_TYPE181=(CommonTree)match(input,INSTRUCTION_FORMAT35c_TYPE,FOLLOW_INSTRUCTION_FORMAT35c_TYPE_in_insn_format35c_type3150); 
			pushFollow(FOLLOW_register_list_in_insn_format35c_type3152);
			register_list182=register_list();
			state._fsp--;

			pushFollow(FOLLOW_nonvoid_type_descriptor_in_insn_format35c_type3154);
	...
	public final void insn_format3rc_call_site() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT3rc_CALL_SITE,FOLLOW_I_STATEMENT_FORMAT3rc_CALL_SITE_in_insn_format3rc_call_site3182); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT3rc_CALL_SITE184=(CommonTree)match(input,INSTRUCTION_FORMAT3rc_CALL_SITE,FOLLOW_INSTRUCTION_FORMAT3rc_CALL_SITE_in_insn_format3rc_call_site3184); 
			pushFollow(FOLLOW_register_range_in_insn_format3rc_call_site3186);
			register_range185=register_range();
			state._fsp--;

			pushFollow(FOLLOW_call_site_reference_in_insn_format3rc_call_site3188);
	...
	public final void insn_format3rc_method() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT3rc_METHOD,FOLLOW_I_STATEMENT_FORMAT3rc_METHOD_in_insn_format3rc_method3211); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT3rc_METHOD187=(CommonTree)match(input,INSTRUCTION_FORMAT3rc_METHOD,FOLLOW_INSTRUCTION_FORMAT3rc_METHOD_in_insn_format3rc_method3213); 
			pushFollow(FOLLOW_register_range_in_insn_format3rc_method3215);
			register_range188=register_range();
			state._fsp--;

			pushFollow(FOLLOW_method_reference_in_insn_format3rc_method3217);
	...
	public final void insn_format3rc_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT3rc_TYPE,FOLLOW_I_STATEMENT_FORMAT3rc_TYPE_in_insn_format3rc_type3240); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT3rc_TYPE190=(CommonTree)match(input,INSTRUCTION_FORMAT3rc_TYPE,FOLLOW_INSTRUCTION_FORMAT3rc_TYPE_in_insn_format3rc_type3242); 
			pushFollow(FOLLOW_register_range_in_insn_format3rc_type3244);
			register_range191=register_range();
			state._fsp--;

			pushFollow(FOLLOW_nonvoid_type_descriptor_in_insn_format3rc_type3246);
	...
	public final void insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT45cc_METHOD,FOLLOW_I_STATEMENT_FORMAT45cc_METHOD_in_insn_format45cc_method3269); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT45cc_METHOD193=(CommonTree)match(input,INSTRUCTION_FORMAT45cc_METHOD,FOLLOW_INSTRUCTION_FORMAT45cc_METHOD_in_insn_format45cc_method3271); 
			pushFollow(FOLLOW_register_list_in_insn_format45cc_method3273);
			register_list194=register_list();
			state._fsp--;

			pushFollow(FOLLOW_method_reference_in_insn_format45cc_method3275);
			method_reference195=method_reference();
			state._fsp--;

			pushFollow(FOLLOW_method_prototype_in_insn_format45cc_method3277);
	...
	public final void insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT4rcc_METHOD,FOLLOW_I_STATEMENT_FORMAT4rcc_METHOD_in_insn_format4rcc_method3300); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT4rcc_METHOD197=(CommonTree)match(input,INSTRUCTION_FORMAT4rcc_METHOD,FOLLOW_INSTRUCTION_FORMAT4rcc_METHOD_in_insn_format4rcc_method3302); 
			pushFollow(FOLLOW_register_range_in_insn_format4rcc_method3304);
			register_range198=register_range();
			state._fsp--;

			pushFollow(FOLLOW_method_reference_in_insn_format4rcc_method3306);
			method_reference199=method_reference();
			state._fsp--;

			pushFollow(FOLLOW_method_prototype_in_insn_format4rcc_method3308);
	...
	public final void insn_format51l_type() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_FORMAT51l,FOLLOW_I_STATEMENT_FORMAT51l_in_insn_format51l_type3331); 
			match(input, Token.DOWN, null); 
			INSTRUCTION_FORMAT51l201=(CommonTree)match(input,INSTRUCTION_FORMAT51l,FOLLOW_INSTRUCTION_FORMAT51l_in_insn_format51l_type3333); 
			REGISTER202=(CommonTree)match(input,REGISTER,FOLLOW_REGISTER_in_insn_format51l_type3335); 
			pushFollow(FOLLOW_fixed_64bit_literal_in_insn_format51l_type3337);
	...
	public final void insn_array_data_directive() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_ARRAY_DATA,FOLLOW_I_STATEMENT_ARRAY_DATA_in_insn_array_data_directive3360); 
			match(input, Token.DOWN, null); 
			match(input,I_ARRAY_ELEMENT_SIZE,FOLLOW_I_ARRAY_ELEMENT_SIZE_in_insn_array_data_directive3363); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_short_integral_literal_in_insn_array_data_directive3365);
			short_integral_literal204=short_integral_literal();
			state._fsp--;

			match(input, Token.UP, null); 

			pushFollow(FOLLOW_array_elements_in_insn_array_data_directive3368);
	...
	public final void insn_packed_switch_directive() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_PACKED_SWITCH,FOLLOW_I_STATEMENT_PACKED_SWITCH_in_insn_packed_switch_directive3390); 
			match(input, Token.DOWN, null); 
			match(input,I_PACKED_SWITCH_START_KEY,FOLLOW_I_PACKED_SWITCH_START_KEY_in_insn_packed_switch_directive3393); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_fixed_32bit_literal_in_insn_packed_switch_directive3395);
			fixed_32bit_literal206=fixed_32bit_literal();
			state._fsp--;

			match(input, Token.UP, null); 

			pushFollow(FOLLOW_packed_switch_elements_in_insn_packed_switch_directive3398);
	...
	public final void insn_sparse_switch_directive() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_STATEMENT_SPARSE_SWITCH,FOLLOW_I_STATEMENT_SPARSE_SWITCH_in_insn_sparse_switch_directive3422); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_sparse_switch_elements_in_insn_sparse_switch_directive3424);
	...
	public final String array_descriptor() throws RecognitionException {
		...
		try {
			...
			{
			ARRAY_TYPE_PREFIX209=(CommonTree)match(input,ARRAY_TYPE_PREFIX,FOLLOW_ARRAY_TYPE_PREFIX_in_array_descriptor3445); 
			...
			switch (alt40) {
				case 1 :
					...
					{
					PRIMITIVE_TYPE210=(CommonTree)match(input,PRIMITIVE_TYPE,FOLLOW_PRIMITIVE_TYPE_in_array_descriptor3449); 
				...
				case 2 :
					...
					{
					CLASS_DESCRIPTOR211=(CommonTree)match(input,CLASS_DESCRIPTOR,FOLLOW_CLASS_DESCRIPTOR_in_array_descriptor3477); 
		...
		try {
			...
			switch (alt41) {
				case 1 :
					...
					{
					match(input,PRIMITIVE_TYPE,FOLLOW_PRIMITIVE_TYPE_in_nonvoid_type_descriptor3495); 
				...
				case 2 :
					...
					{
					match(input,CLASS_DESCRIPTOR,FOLLOW_CLASS_DESCRIPTOR_in_nonvoid_type_descriptor3503); 
					 retval.type = input.getTokenStream().toString(input.getTreeAdaptor().getTokenStartIndex(retval.start),input.getTreeAdaptor().getTokenStopIndex(retval.start)); 
					}
					break;
				case 3 :
					...
					{
					pushFollow(FOLLOW_array_descriptor_in_nonvoid_type_descriptor3511);
		...
		try {
			...
			switch (alt42) {
				case 1 :
					...
					{
					match(input,CLASS_DESCRIPTOR,FOLLOW_CLASS_DESCRIPTOR_in_reference_type_descriptor3532); 
					 retval.type = input.getTokenStream().toString(input.getTreeAdaptor().getTokenStartIndex(retval.start),input.getTreeAdaptor().getTokenStopIndex(retval.start)); 
					}
					break;
				case 2 :
					...
					{
					pushFollow(FOLLOW_array_descriptor_in_reference_type_descriptor3540);
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,VOID_TYPE,FOLLOW_VOID_TYPE_in_type_descriptor3560); 
					type = "V";
					}
					break;
				case 2 :
					...
					{
					pushFollow(FOLLOW_nonvoid_type_descriptor_in_type_descriptor3568);
		...
		try {
			...
			switch (alt44) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_long_literal_in_short_integral_literal3586);
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_integer_literal_in_short_integral_literal3598);
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_short_literal_in_short_integral_literal3610);
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_char_literal_in_short_integral_literal3618);
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_byte_literal_in_short_integral_literal3626);
		...
		try {
			...
			switch (alt45) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_long_literal_in_integral_literal3641);
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_integer_literal_in_integral_literal3653);
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_short_literal_in_integral_literal3661);
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_byte_literal_in_integral_literal3669);
	...
	public final int integer_literal() throws RecognitionException {
		...
		try {
			...
			{
			INTEGER_LITERAL224=(CommonTree)match(input,INTEGER_LITERAL,FOLLOW_INTEGER_LITERAL_in_integer_literal3685); 
	...
	public final long long_literal() throws RecognitionException {
		...
		try {
			...
			{
			LONG_LITERAL225=(CommonTree)match(input,LONG_LITERAL,FOLLOW_LONG_LITERAL_in_long_literal3700); 
	...
	public final short short_literal() throws RecognitionException {
		...
		try {
			...
			{
			SHORT_LITERAL226=(CommonTree)match(input,SHORT_LITERAL,FOLLOW_SHORT_LITERAL_in_short_literal3715); 
	...
	public final byte byte_literal() throws RecognitionException {
		...
		try {
			...
			{
			BYTE_LITERAL227=(CommonTree)match(input,BYTE_LITERAL,FOLLOW_BYTE_LITERAL_in_byte_literal3730); 
	...
	public final float float_literal() throws RecognitionException {
		...
		try {
			...
			{
			FLOAT_LITERAL228=(CommonTree)match(input,FLOAT_LITERAL,FOLLOW_FLOAT_LITERAL_in_float_literal3745); 
	...
	public final double double_literal() throws RecognitionException {
		...
		try {
			...
			{
			DOUBLE_LITERAL229=(CommonTree)match(input,DOUBLE_LITERAL,FOLLOW_DOUBLE_LITERAL_in_double_literal3760); 
	...
	public final char char_literal() throws RecognitionException {
		...
		try {
			...
			{
			CHAR_LITERAL230=(CommonTree)match(input,CHAR_LITERAL,FOLLOW_CHAR_LITERAL_in_char_literal3775); 
	...
	public final String string_literal() throws RecognitionException {
		...
		try {
			...
			{
			STRING_LITERAL231=(CommonTree)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_string_literal3790); 
	...
	public final boolean bool_literal() throws RecognitionException {
		...
		try {
			...
			{
			BOOL_LITERAL232=(CommonTree)match(input,BOOL_LITERAL,FOLLOW_BOOL_LITERAL_in_bool_literal3809); 
	...
	public final List<EncodedValue> array_literal() throws RecognitionException {
		...
		try {
			...
			{
			elements = Lists.newArrayList();
			match(input,I_ENCODED_ARRAY,FOLLOW_I_ENCODED_ARRAY_in_array_literal3831); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_literal_in_array_literal3834);
						literal233=literal();
						state._fsp--;
	...
	public final Set<Annotation> annotations() throws RecognitionException {
		...
		try {
			...
			match(input,I_ANNOTATIONS,FOLLOW_I_ANNOTATIONS_in_annotations3859); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_annotation_in_annotations3862);
	...
	public final Annotation annotation() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ANNOTATION,FOLLOW_I_ANNOTATION_in_annotation3891); 
			match(input, Token.DOWN, null); 
			ANNOTATION_VISIBILITY235=(CommonTree)match(input,ANNOTATION_VISIBILITY,FOLLOW_ANNOTATION_VISIBILITY_in_annotation3893); 
			pushFollow(FOLLOW_subannotation_in_annotation3895);
	...
	public final AnnotationElement annotation_element() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ANNOTATION_ELEMENT,FOLLOW_I_ANNOTATION_ELEMENT_in_annotation_element3916); 
			match(input, Token.DOWN, null); 
			SIMPLE_NAME237=(CommonTree)match(input,SIMPLE_NAME,FOLLOW_SIMPLE_NAME_in_annotation_element3918); 
			pushFollow(FOLLOW_literal_in_annotation_element3920);
			literal238=literal();
			state._fsp--;
	...
	public final smaliTreeWalker.subannotation_return subannotation() throws RecognitionException {
		...
		try {
			...
			match(input,I_SUBANNOTATION,FOLLOW_I_SUBANNOTATION_in_subannotation3947); 
			match(input, Token.DOWN, null); 
			CLASS_DESCRIPTOR240=(CommonTree)match(input,CLASS_DESCRIPTOR,FOLLOW_CLASS_DESCRIPTOR_in_subannotation3957); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_annotation_element_in_subannotation3968);
	...
	public final ImmutableFieldReference field_literal() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ENCODED_FIELD,FOLLOW_I_ENCODED_FIELD_in_field_literal4007); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_field_reference_in_field_literal4009);
	...
	public final ImmutableMethodReference method_literal() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ENCODED_METHOD,FOLLOW_I_ENCODED_METHOD_in_method_literal4030); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_method_reference_in_method_literal4032);
	...
	public final ImmutableFieldReference enum_literal() throws RecognitionException {
		...
		try {
			...
			{
			match(input,I_ENCODED_ENUM,FOLLOW_I_ENCODED_ENUM_in_enum_literal4053); 
			match(input, Token.DOWN, null); 
			pushFollow(FOLLOW_field_reference_in_enum_literal4055);
	...
	public static final BitSet FOLLOW_header_in_smali_file54 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L});
	public static final BitSet FOLLOW_methods_in_smali_file56 = new BitSet(new long[]{0x0000000000000000L,0x0008000000000000L});
	public static final BitSet FOLLOW_fields_in_smali_file58 = new BitSet(new long[]{0x0000000000000000L,0x0000000200000000L});
	public static final BitSet FOLLOW_annotations_in_smali_file60 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_class_spec_in_header85 = new BitSet(new long[]{0x0000000000000000L,0x0040000000000000L,0x0020000000000400L});
	public static final BitSet FOLLOW_super_spec_in_header87 = new BitSet(new long[]{0x0000000000000000L,0x0040000000000000L,0x0000000000000400L});
	public static final BitSet FOLLOW_implements_list_in_header90 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000400L});
	public static final BitSet FOLLOW_source_spec_in_header92 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_class_spec110 = new BitSet(new long[]{0x0000000000000000L,0x0000000080000000L});
	...
	public static final BitSet FOLLOW_implements_spec_in_implements_list184 = new BitSet(new long[]{0x0000000000000002L,0x0040000000000000L});
	...
	public static final BitSet FOLLOW_field_in_fields317 = new BitSet(new long[]{0x0000000000000008L,0x0004000000000000L});
	public static final BitSet FOLLOW_I_METHODS_in_methods349 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_method_in_methods358 = new BitSet(new long[]{0x0000000000000008L,0x0800000000000000L});
	public static final BitSet FOLLOW_I_FIELD_in_field383 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_field385 = new BitSet(new long[]{0x0000000000000000L,0x0000000080000000L});
	public static final BitSet FOLLOW_access_list_in_field387 = new BitSet(new long[]{0x0000000000000000L,0x0020000000000000L});
	...
	public static final BitSet FOLLOW_field_initial_value_in_field395 = new BitSet(new long[]{0x0000000000000008L,0x0000000200000000L});
	...
	public static final BitSet FOLLOW_fixed_64bit_literal_number_in_array_elements817 = new BitSet(new long[]{0x0000008000809808L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	...
	public static final BitSet FOLLOW_label_ref_in_packed_switch_elements862 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	...
	public static final BitSet FOLLOW_fixed_32bit_literal_in_sparse_switch_elements907 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_sparse_switch_elements909 = new BitSet(new long[]{0x0000008000009808L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_I_METHOD_in_method961 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_method_name_and_prototype_in_method969 = new BitSet(new long[]{0x0000000000000000L,0x0000000080000000L});
	public static final BitSet FOLLOW_access_list_in_method977 = new BitSet(new long[]{0x0000000000000000L,0x8400000000000000L,0x0000000000000040L});
	public static final BitSet FOLLOW_registers_directive_in_method1004 = new BitSet(new long[]{0x0000000000000000L,0x8000000000000000L});
	public static final BitSet FOLLOW_ordered_method_items_in_method1061 = new BitSet(new long[]{0x0000000000000000L,0x0000020000000000L});
	public static final BitSet FOLLOW_catches_in_method1069 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000008L});
	public static final BitSet FOLLOW_parameters_in_method1077 = new BitSet(new long[]{0x0000000000000000L,0x0000000200000000L});
	...
	public static final BitSet FOLLOW_SIMPLE_NAME_in_method_name_and_prototype1136 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	...
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_method_type_list1172 = new BitSet(new long[]{0x0000000000010102L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	...
	public static final BitSet FOLLOW_SIMPLE_NAME_in_call_site_reference1207 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_string_literal_in_call_site_reference1211 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	public static final BitSet FOLLOW_method_prototype_in_call_site_reference1213 = new BitSet(new long[]{0x0000000000000000L,0x0000002000000000L});
	public static final BitSet FOLLOW_call_site_extra_arguments_in_call_site_reference1223 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_method_reference_in_call_site_reference1225 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_METHOD_HANDLE_TYPE_FIELD_in_method_handle_type1245 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_METHOD_HANDLE_TYPE_METHOD_in_method_handle_type1249 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_method_handle_type_in_method_handle_reference1264 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_field_reference_in_method_handle_reference1267 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_method_reference_in_method_handle_reference1271 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_ENCODED_METHOD_HANDLE_in_method_handle_literal1288 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x6000000000000000L});
	public static final BitSet FOLLOW_method_handle_reference_in_method_handle_literal1290 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_reference_type_descriptor_in_method_reference1306 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_method_reference1309 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	public static final BitSet FOLLOW_method_prototype_in_method_reference1311 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_reference_type_descriptor_in_field_reference1328 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_field_reference1331 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_field_reference1333 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_REGISTERS_in_registers_directive1359 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_I_LOCALS_in_registers_directive1371 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_short_integral_literal_in_registers_directive1389 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_LABEL_in_label_def1409 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_label_def1411 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_CATCHES_in_catches1437 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_catch_directive_in_catches1439 = new BitSet(new long[]{0x0000000000000008L,0x0000018000000000L});
	public static final BitSet FOLLOW_catchall_directive_in_catches1442 = new BitSet(new long[]{0x0000000000000008L,0x0000010000000000L});
	public static final BitSet FOLLOW_I_CATCH_in_catch_directive1455 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_catch_directive1457 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_catch_directive1461 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_catch_directive1465 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_catch_directive1469 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_CATCHALL_in_catchall_directive1485 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_label_ref_in_catchall_directive1489 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_catchall_directive1493 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_catchall_directive1497 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_PARAMETERS_in_parameters1514 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_parameter_in_parameters1517 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000004L});
	public static final BitSet FOLLOW_I_PARAMETER_in_parameter1533 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_parameter1535 = new BitSet(new long[]{0x0000000000000000L,0x0000000200000000L,0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_string_literal_in_parameter1537 = new BitSet(new long[]{0x0000000000000000L,0x0000000200000000L});
	public static final BitSet FOLLOW_annotations_in_parameter1540 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_line_in_debug_directive1557 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_local_in_debug_directive1563 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_end_local_in_debug_directive1569 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_restart_local_in_debug_directive1575 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_prologue_in_debug_directive1581 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_epilogue_in_debug_directive1587 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_source_in_debug_directive1593 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_LINE_in_line1604 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_integral_literal_in_line1606 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_LOCAL_in_local1624 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_local1626 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000010001L});
	public static final BitSet FOLLOW_NULL_LITERAL_in_local1630 = new BitSet(new long[]{0x0000000000010108L,0x0000000000000000L,0x0000000000000000L,0x0000000000010080L});
	public static final BitSet FOLLOW_string_literal_in_local1636 = new BitSet(new long[]{0x0000000000010108L,0x0000000000000000L,0x0000000000000000L,0x0000000000010080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_local1639 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_string_literal_in_local1644 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_END_LOCAL_in_end_local1665 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_end_local1667 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_RESTART_LOCAL_in_restart_local1685 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_restart_local1687 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_PROLOGUE_in_prologue1704 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_EPILOGUE_in_epilogue1720 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_SOURCE_in_source1737 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_string_literal_in_source1739 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_CALL_SITE_EXTRA_ARGUMENTS_in_call_site_extra_arguments1765 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_literal_in_call_site_extra_arguments1768 = new BitSet(new long[]{0x0000008000819908L,0x2000F80020000000L,0x0410000000000000L,0x0000000000111081L});
	public static final BitSet FOLLOW_I_ORDERED_METHOD_ITEMS_in_ordered_method_items1784 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_label_def_in_ordered_method_items1787 = new BitSet(new long[]{0x0000000000000008L,0x0383000000000000L,0x000FFFFFFFFFF620L});
	public static final BitSet FOLLOW_instruction_in_ordered_method_items1791 = new BitSet(new long[]{0x0000000000000008L,0x0383000000000000L,0x000FFFFFFFFFF620L});
	public static final BitSet FOLLOW_debug_directive_in_ordered_method_items1795 = new BitSet(new long[]{0x0000000000000008L,0x0383000000000000L,0x000FFFFFFFFFF620L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_label_ref1811 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_REGISTER_LIST_in_register_list1836 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_register_list1845 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_I_REGISTER_RANGE_in_register_range1870 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_REGISTER_in_register_range1875 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_register_range1879 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_verification_error_reference1902 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_field_reference_in_verification_error_reference1912 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_method_reference_in_verification_error_reference1922 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VERIFICATION_ERROR_TYPE_in_verification_error_type1939 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format10t_in_instruction1953 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format10x_in_instruction1959 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_insn_format21c_method_handle_in_instruction2001 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21c_method_type_in_instruction2007 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21c_string_in_instruction2013 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21c_type_in_instruction2019 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21ih_in_instruction2025 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21lh_in_instruction2031 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21s_in_instruction2037 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format21t_in_instruction2043 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format22b_in_instruction2049 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format22c_field_in_instruction2055 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format22c_type_in_instruction2061 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_insn_format35c_call_site_in_instruction2121 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format35c_method_in_instruction2127 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format35c_type_in_instruction2133 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format3rc_call_site_in_instruction2139 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format3rc_method_in_instruction2145 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format3rc_type_in_instruction2151 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format45cc_method_in_instruction2157 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format4rcc_method_in_instruction2163 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_format51l_type_in_instruction2169 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_array_data_directive_in_instruction2175 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_packed_switch_directive_in_instruction2181 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insn_sparse_switch_directive_in_instruction2187 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT10t_in_insn_format10t2211 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT10t_in_insn_format10t2213 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format10t2215 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT10x_in_insn_format10x2238 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT10x_in_insn_format10x2240 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT11n_in_insn_format11n2263 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT11n_in_insn_format11n2265 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format11n2267 = new BitSet(new long[]{0x0000000000009000L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_short_integral_literal_in_insn_format11n2269 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT11x_in_insn_format11x2292 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT11x_in_insn_format11x2294 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format11x2296 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT12x_in_insn_format12x2319 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT12x_in_insn_format12x2321 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format12x2325 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format12x2329 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT20bc_in_insn_format20bc2352 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT20bc_in_insn_format20bc2354 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000080000L});
	public static final BitSet FOLLOW_verification_error_type_in_insn_format20bc2356 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_verification_error_reference_in_insn_format20bc2358 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT20t_in_insn_format20t2381 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT20t_in_insn_format20t2383 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format20t2385 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21c_FIELD_in_insn_format21c_field2408 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_set_in_insn_format21c_field2412 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21c_field2420 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_field_reference_in_insn_format21c_field2422 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21c_METHOD_HANDLE_in_insn_format21c_method_handle2445 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21c_METHOD_HANDLE_in_insn_format21c_method_handle2450 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21c_method_handle2453 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x6000000000000000L});
	public static final BitSet FOLLOW_method_handle_reference_in_insn_format21c_method_handle2455 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21c_METHOD_TYPE_in_insn_format21c_method_type2478 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21c_METHOD_TYPE_in_insn_format21c_method_type2483 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21c_method_type2486 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	public static final BitSet FOLLOW_method_prototype_in_insn_format21c_method_type2488 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21c_STRING_in_insn_format21c_string2511 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21c_STRING_in_insn_format21c_string2513 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21c_string2515 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_string_literal_in_insn_format21c_string2517 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21c_TYPE_in_insn_format21c_type2540 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21c_TYPE_in_insn_format21c_type2542 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21c_type2544 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_insn_format21c_type2546 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21ih_in_insn_format21ih2569 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21ih_in_insn_format21ih2571 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21ih2573 = new BitSet(new long[]{0x0000008000009800L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_fixed_32bit_literal_in_insn_format21ih2575 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21lh_in_insn_format21lh2598 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21lh_in_insn_format21lh2600 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21lh2602 = new BitSet(new long[]{0x0000008000809800L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_fixed_64bit_literal_in_insn_format21lh2604 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21s_in_insn_format21s2627 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21s_in_insn_format21s2629 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21s2631 = new BitSet(new long[]{0x0000000000009000L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_short_integral_literal_in_insn_format21s2633 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT21t_in_insn_format21t2656 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT21t_in_insn_format21t2658 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format21t2660 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format21t2662 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22b_in_insn_format22b2685 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT22b_in_insn_format22b2687 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22b2691 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22b2695 = new BitSet(new long[]{0x0000000000009000L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_short_integral_literal_in_insn_format22b2697 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22c_FIELD_in_insn_format22c_field2720 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_set_in_insn_format22c_field2724 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22c_field2734 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22c_field2738 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_field_reference_in_insn_format22c_field2740 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22c_TYPE_in_insn_format22c_type2763 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT22c_TYPE_in_insn_format22c_type2765 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22c_type2769 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22c_type2773 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_insn_format22c_type2775 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22s_in_insn_format22s2798 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT22s_in_insn_format22s2800 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22s2804 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22s2808 = new BitSet(new long[]{0x0000000000009000L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_short_integral_literal_in_insn_format22s2810 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22t_in_insn_format22t2833 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT22t_in_insn_format22t2835 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22t2839 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22t2843 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format22t2845 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT22x_in_insn_format22x2868 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT22x_in_insn_format22x2870 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22x2874 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format22x2878 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT23x_in_insn_format23x2901 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT23x_in_insn_format23x2903 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format23x2907 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format23x2911 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format23x2915 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT30t_in_insn_format30t2938 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT30t_in_insn_format30t2940 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format30t2942 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT31c_in_insn_format31c2965 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT31c_in_insn_format31c2967 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format31c2969 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_string_literal_in_insn_format31c2971 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT31i_in_insn_format31i2994 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT31i_in_insn_format31i2996 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format31i2998 = new BitSet(new long[]{0x0000008000009800L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_fixed_32bit_literal_in_insn_format31i3000 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT31t_in_insn_format31t3023 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT31t_in_insn_format31t3025 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format31t3027 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_label_ref_in_insn_format31t3029 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT32x_in_insn_format32x3052 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT32x_in_insn_format32x3054 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format32x3058 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format32x3062 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT35c_CALL_SITE_in_insn_format35c_call_site3090 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT35c_CALL_SITE_in_insn_format35c_call_site3092 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_register_list_in_insn_format35c_call_site3094 = new BitSet(new long[]{0x0000000000000000L,0x0000004000000000L});
	public static final BitSet FOLLOW_call_site_reference_in_insn_format35c_call_site3096 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT35c_METHOD_in_insn_format35c_method3119 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT35c_METHOD_in_insn_format35c_method3121 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_register_list_in_insn_format35c_method3123 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_method_reference_in_insn_format35c_method3125 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT35c_TYPE_in_insn_format35c_type3148 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT35c_TYPE_in_insn_format35c_type3150 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_register_list_in_insn_format35c_type3152 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_insn_format35c_type3154 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT3rc_CALL_SITE_in_insn_format3rc_call_site3182 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT3rc_CALL_SITE_in_insn_format3rc_call_site3184 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_register_range_in_insn_format3rc_call_site3186 = new BitSet(new long[]{0x0000000000000000L,0x0000004000000000L});
	public static final BitSet FOLLOW_call_site_reference_in_insn_format3rc_call_site3188 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT3rc_METHOD_in_insn_format3rc_method3211 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT3rc_METHOD_in_insn_format3rc_method3213 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_register_range_in_insn_format3rc_method3215 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_method_reference_in_insn_format3rc_method3217 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT3rc_TYPE_in_insn_format3rc_type3240 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT3rc_TYPE_in_insn_format3rc_type3242 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_register_range_in_insn_format3rc_type3244 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_insn_format3rc_type3246 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT45cc_METHOD_in_insn_format45cc_method3269 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT45cc_METHOD_in_insn_format45cc_method3271 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_register_list_in_insn_format45cc_method3273 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_method_reference_in_insn_format45cc_method3275 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	public static final BitSet FOLLOW_method_prototype_in_insn_format45cc_method3277 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT4rcc_METHOD_in_insn_format4rcc_method3300 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT4rcc_METHOD_in_insn_format4rcc_method3302 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_register_range_in_insn_format4rcc_method3304 = new BitSet(new long[]{0x0000000000010100L,0x0000000000000000L,0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_method_reference_in_insn_format4rcc_method3306 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
	public static final BitSet FOLLOW_method_prototype_in_insn_format4rcc_method3308 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_FORMAT51l_in_insn_format51l_type3331 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_INSTRUCTION_FORMAT51l_in_insn_format51l_type3333 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
	public static final BitSet FOLLOW_REGISTER_in_insn_format51l_type3335 = new BitSet(new long[]{0x0000008000809800L,0x0000000020000000L,0x0400000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_fixed_64bit_literal_in_insn_format51l_type3337 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_ARRAY_DATA_in_insn_array_data_directive3360 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_I_ARRAY_ELEMENT_SIZE_in_insn_array_data_directive3363 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_short_integral_literal_in_insn_array_data_directive3365 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_array_elements_in_insn_array_data_directive3368 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_PACKED_SWITCH_in_insn_packed_switch_directive3390 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_I_PACKED_SWITCH_START_KEY_in_insn_packed_switch_directive3393 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_fixed_32bit_literal_in_insn_packed_switch_directive3395 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_packed_switch_elements_in_insn_packed_switch_directive3398 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_STATEMENT_SPARSE_SWITCH_in_insn_sparse_switch_directive3422 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_sparse_switch_elements_in_insn_sparse_switch_directive3424 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_ARRAY_TYPE_PREFIX_in_array_descriptor3445 = new BitSet(new long[]{0x0000000000010000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
	public static final BitSet FOLLOW_PRIMITIVE_TYPE_in_array_descriptor3449 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_array_descriptor3477 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PRIMITIVE_TYPE_in_nonvoid_type_descriptor3495 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_nonvoid_type_descriptor3503 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_descriptor_in_nonvoid_type_descriptor3511 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_reference_type_descriptor3532 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_descriptor_in_reference_type_descriptor3540 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VOID_TYPE_in_type_descriptor3560 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nonvoid_type_descriptor_in_type_descriptor3568 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_long_literal_in_short_integral_literal3586 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_integer_literal_in_short_integral_literal3598 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_short_literal_in_short_integral_literal3610 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_char_literal_in_short_integral_literal3618 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_byte_literal_in_short_integral_literal3626 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_long_literal_in_integral_literal3641 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_integer_literal_in_integral_literal3653 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_short_literal_in_integral_literal3661 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_byte_literal_in_integral_literal3669 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTEGER_LITERAL_in_integer_literal3685 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LONG_LITERAL_in_long_literal3700 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SHORT_LITERAL_in_short_literal3715 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BYTE_LITERAL_in_byte_literal3730 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FLOAT_LITERAL_in_float_literal3745 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DOUBLE_LITERAL_in_double_literal3760 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHAR_LITERAL_in_char_literal3775 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_STRING_LITERAL_in_string_literal3790 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BOOL_LITERAL_in_bool_literal3809 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_I_ENCODED_ARRAY_in_array_literal3831 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_literal_in_array_literal3834 = new BitSet(new long[]{0x0000008000819908L,0x2000F80020000000L,0x0410000000000000L,0x0000000000111081L});
	public static final BitSet FOLLOW_I_ANNOTATIONS_in_annotations3859 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_annotation_in_annotations3862 = new BitSet(new long[]{0x0000000000000008L,0x0000000100000000L});
	public static final BitSet FOLLOW_I_ANNOTATION_in_annotation3891 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_ANNOTATION_VISIBILITY_in_annotation3893 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0010000000000000L});
	public static final BitSet FOLLOW_subannotation_in_annotation3895 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_ANNOTATION_ELEMENT_in_annotation_element3916 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_SIMPLE_NAME_in_annotation_element3918 = new BitSet(new long[]{0x0000008000819900L,0x2000F80020000000L,0x0410000000000000L,0x0000000000111081L});
	public static final BitSet FOLLOW_literal_in_annotation_element3920 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_SUBANNOTATION_in_subannotation3947 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_CLASS_DESCRIPTOR_in_subannotation3957 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L});
	public static final BitSet FOLLOW_annotation_element_in_subannotation3968 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L});
	public static final BitSet FOLLOW_I_ENCODED_FIELD_in_field_literal4007 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_field_reference_in_field_literal4009 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_ENCODED_METHOD_in_method_literal4030 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_method_reference_in_method_literal4032 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_I_ENCODED_ENUM_in_enum_literal4053 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_field_reference_in_enum_literal4055 = new BitSet(new long[]{0x0000000000000008L});
}
